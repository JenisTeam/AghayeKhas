...
--------------------------------
if matches[1]:lower() == "راهنمای فان" then
...
••#دریافت کردن ساعت توسط ربات به صورت استیکر 💠
➖➖➖➖➖➖➖➖➖
*> short [ link ]*
> کوتاه کردن [لینک]

••#کوتاه کننده انواع لینک توسط سایت های مختلف 💠
➖➖➖➖➖➖➖➖➖
*> voice [ text ]*
> ویس [ متن ]

••#تبدیل کردن متن به صدا 💠
➖➖➖➖➖➖➖➖➖
*> tr [ lang ] [ word ]*
> ترجمه [ زبان ] [ متن ]

••#ترجمه کردن کلمه های فارسی به انگلیسی وبرعکس 💠
...
••#تبدیل کردن متن به استیکر 💠
➖➖➖➖➖➖➖➖➖
*> create photo [ word ]*
> ساخت عکس [ متن ]

••#تبدیل کردن متن به عکس 💠
➖➖➖➖➖➖➖➖➖
*> praytime [ city ]*
> اذان [ شهر ]

••#دریافت کردن اذان شهر مورد نظر 💠
➖➖➖➖➖➖➖➖➖
*> calc [ number ]*
> حساب کن [ معادله ]

••#حساب کردن (جمع،تفریق،ضرب،تقسیم و غیره) 💠
➖➖➖➖➖➖➖➖➖
*> tosticker [ reply ]*
> استیکر [ رپلی کردن ]

••#تبدیل کردن عکس به استیکر 💠
➖➖➖➖➖➖➖➖➖
*> tophoto [ reply ]*
> عکس [ رپلی کردن ]

••#تبدیل کردن استیکر‌ به عکس 💠
➖➖➖➖➖➖➖➖➖
*> myphoto*
> عکس من

••#دریافت کردن عکس پروفایل خود 💠
➖➖➖➖➖➖➖➖➖
*> weather [ city ]*
> اب و هوا [ شهرمورد نظر ]
